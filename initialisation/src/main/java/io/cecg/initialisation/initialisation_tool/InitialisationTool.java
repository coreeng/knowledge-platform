package io.cecg.initialisation.initialisation_tool;

import io.cecg.initialisation.github_manager.GitHubManager;
import io.cecg.initialisation.issue_manager.IssueManager;
import io.cecg.initialisation.model.CmdArguments;
import io.cecg.initialisation.module_manager.ModuleManager;
        ...
        try {
            ...
            if (cmd.hasOption("help")) {
                String mandatoryParams = """
                        ...
                        --bootcampee-repo      ---- The repository of the bootcamp participant. If it doesn't exist, it will be created.""";
                ...
                String commandUsage = "\n\n./initialisation-tool --git-token=<yourToken> --org=<yourOrg> --modules=<yourCommaSeparatedModulesList> --module-location=<Your/Module/Location> --bootcampee-repo=<bootcampeeRepo>";
